...
//public record CreatePaySlipByEachMonthCommand() : IRequest<string>
//{
//    public Guid EmployeeId { get; set; }
//    public DateTime ToDate { get; set; }
//}

//public class CreatePaySlipByEachMonthCommandHandler : IRequestHandler<CreatePaySlipByEachMonthCommand, string>
//{
//    private readonly IApplicationDbContext _context;

//    public CreatePaySlipByEachMonthCommandHandler(IApplicationDbContext context)
//    {
//        _context = context;
//    }

//    public async Task<string> Handle(CreatePaySlipByEachMonthCommand request, CancellationToken cancellationToken)
//    {
//        try
//        {
//            //khai báo
...
//                    throw new NotFoundException($"{request.ToDate.ToString("dd/MM/yyyy")} là ngày bắt đầu của hợp đồng chưa thể tính lương");
//                }
//                else
//                {
...
//                    throw new NotFoundException($"Hợp đồng này đã được tính lương ngày: {request.ToDate.ToString("dd/MM/yyyy")}");
//                }
//                else
//                {
...
//                throw new NotFoundException("Vui lòng cập nhật danh sách ngày làm việc hàng năm");
//            }
...
//                 .ToListAsync(cancellationToken);*/
//            var TimeAttendanceLog = await _context.TimeAttendanceLogs
//                 .Where(x => x.EmployeeId == EmployeeContract.EmployeeId && x.StartTime.Month == request.ToDate.Month)
//                 .ToListAsync(cancellationToken);
...
//                if (Log.Ducation == 0)
//                {
//                    throw new NotFoundException("Vui lòng tính chấm công cho nhân viên trước khi tính lương");
//                }
//                if (Log.Ducation > 8)
//                {
//                    Actual_Work_Hours += 8;
...
//                .ToListAsync(cancellationToken);*/
//            var OvertimeLog = await _context.OvertimeLogs
//                .Where(x => x.EmployeeId == EmployeeContract.EmployeeId && x.Status == OvertimeLogStatus.Approved && x.IsDeleted == false && x.StartDate.Month == request.ToDate.Month)
//                .ToListAsync(cancellationToken);
//            var LeaveLog = await _context.LeaveLogs
//                .Where(x => x.EmployeeId == EmployeeContract.EmployeeId && x.Status == LeaveLogStatus.Approved && x.IsDeleted == false && x.StartDate.Month == request.ToDate.Month)
//                .ToListAsync(cancellationToken);
