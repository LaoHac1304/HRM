...
//            {
//                throw new NotFoundException("Không tìm thấy bất kỳ thông tin nhân viên nào");
//            }
...
//                {
//                    throw new NotFoundException($"Không tìm thấy lịch sử chấm công của nhân viên có ID: {EmployeeContract.EmployeeId}");
//                }
...
//                        throw new NotFoundException($"Vui lòng tính chấm công cho nhân viên có ID: {EmployeeContract.EmployeeId} trước khi tính lương");
//                    }
