...
namespace hrOT.Application.Auth.Queries
{
    ...
    public class ResetPasswordHandler : IRequestHandler<ResetPassword, string>
    {
        ...
        public async Task<string> Handle(ResetPassword request, CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex) { throw new Exception($"Lỗi ở ResetPasswordHandler : {ex}"); }
        }
        ...
        private string GenerateRandomPassword()
        {
            ...
            catch (Exception ex) { throw new Exception($"Lỗi ở GenerateRandomPassword: {ex}"); }
        }
        ...
        private async Task SendEmailAsync(string email, string subject, string body)
        {
            ...
            catch (Exception ex) { throw new Exception($"Lỗi ở SendEmailAsync: {ex}"); }
        }
    }
}