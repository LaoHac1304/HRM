...
public record UpdateFamily_CICommand : IRequest<bool>
{
...
public class UpdateFamily_CICommandHandler : IRequestHandler<UpdateFamily_CICommand, bool>
{
    private readonly IApplicationDbContext _context;

    private readonly IWebHostEnvironment _webHostEnvironment;

    public UpdateFamily_CICommandHandler(IApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
    {
        _context = context;
        _webHostEnvironment = webHostEnvironment;
    }

    public async Task<bool> Handle(UpdateFamily_CICommand request, CancellationToken cancellationToken)
    {
